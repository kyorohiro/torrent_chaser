...
SRCS=./src/my_ip_country_detector.cpp ./src/my_target_list_reader.cpp ./src/my_server.cpp ./src/my_db.o ./src/my_torrent.o
OBJS= $(SRCS:.cpp=.o)
TARGET = main.out
...
main.out: ./src/my_ip_country_detector.o ./src/main.o ./src/my_target_list_reader.o ./src/my_server.o ./src/my_db.o ./src/my_torrent.o
